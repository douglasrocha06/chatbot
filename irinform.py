...
/I - O que é bolsa de valores?
/II - O que é renda fixa?
/III - O que é renda variável?
/IV - O que significa pregão?
/V - Qual é a representatividade do touro na bolsa de valores?
/VI - O que o urso significa para a bolsa de valores?
/VII - Qual o significa de Bull Market e Bear Market?
/VIII - O que é Circuit Breaking?
/IX - O que é análise técnica?
/X - O que significa análise fundamentalista?"""
...
@bot.message_handler(commands=["VII"])
def VII(mensagem):
    bot.send_message(mensagem.chat.id, "Renda variável significa investimento que possuem volatidade, como por exemplo a bolsa de valores.\n\nSelecione uma opção abaixo para: \n/voltar\n/inicio")

@bot.message_handler(commands=["VIII"])
def VIII(mensagem):
    bot.send_message(mensagem.chat.id, "Renda variável significa investimento que possuem volatidade, como por exemplo a bolsa de valores.\n\nSelecione uma opção abaixo para: \n/voltar\n/inicio")

@bot.message_handler(commands=["IX"])
def IX(mensagem):
    bot.send_message(mensagem.chat.id, "Renda variável significa investimento que possuem volatidade, como por exemplo a bolsa de valores.\n\nSelecione uma opção abaixo para: \n/voltar\n/inicio")
...
/op1 - O que acontece se não declarar ações?
/op2 - Como declarar venda de ações abaixo de 20 mil?
/op3 - Como pagar Darf de day trade atrasado?
/op4 - O que acontece se eu não pagar a DARF de operações em Day trade?
/op5 - Realizei venda de fundos imobiliário com lucro devo pagar darf?
/op6 - Quando devo pagar DARF de Fundo de Investimentos Imobiliário?
/op7 - Como calcular imposto de renda na venda de fundos de investimento imobiliário?
/op8 - Qual o valor mínimo para pagar o DARF?
/op9 - Quem declara o Imposto de Renda atrasado quando é restituído pela Receita Federal?
/op10 - Perdi dinheiro na bolsa de valores, mesmo assim preciso declarar imposto de renda?"""
